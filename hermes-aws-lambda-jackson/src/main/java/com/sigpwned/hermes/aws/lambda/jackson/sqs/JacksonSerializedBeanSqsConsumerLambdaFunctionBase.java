...
public abstract class JacksonSerializedBeanSqsConsumerLambdaFunctionBase<T>
  ...
  protected JacksonSerializedBeanSqsConsumerLambdaFunctionBase(ObjectMapper mapper, Class<T> type) {
  ...
  protected JacksonSerializedBeanSqsConsumerLambdaFunctionBase(ObjectMapper mapper,
  ...
  protected JacksonSerializedBeanSqsConsumerLambdaFunctionBase(ObjectMapper mapper, JavaType type) {
    super(new JacksonBeanMessageDeserializer<>(mapper, type));
  }
}
